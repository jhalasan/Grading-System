...
//#endregion
//#region src/assets/services/pocketbase.ts
var pb = new Client("http://127.0.0.1:8090");
pb.autoCancellation(false);
//#endregion
//#region src/assets/services/gradeServices.ts
var getClientIpAddress = () => {
	return "127.0.0.1";
};
var getAllGrades = async () => {
	try {
		return await pb.collection("grades").getFullList({
...
var updateGrade = async (gradeId, newGrade, userId) => {
	try {
		const oldRecord = await pb.collection("grades").getOne(gradeId, { expand: "student_id,last_modified_by" });
		const updatedRecord = await pb.collection("grades").update(gradeId, {
...
var getUserName = async (userId) => {
	try {
		return (await pb.collection("users").getOne(userId)).name || userId;
	} catch (error) {
...
//#endregion
//#region src/assets/services/logService.ts
var getActivityLogs = async () => {
	try {
		return await pb.collection("activity_logs").getFullList({ sort: "-created" });
	} catch (error) {
		console.error("Error fetching activity logs:", error);
		throw error;
	}
};
var ActivityLogTable_module_default = {
	container: "_container_124im_1",
	emptyState: "_emptyState_124im_29",
	table: "_table_124im_49",
	value: "_value_124im_135",
	actionBadge: "_actionBadge_124im_153",
	actionCreate: "_actionCreate_124im_173",
	actionUpdate: "_actionUpdate_124im_183",
	actionDelete: "_actionDelete_124im_193",
	ipAddress: "_ipAddress_124im_203"
};
//#endregion
...
//#endregion
//#region src/assets/components/ActivityLogTable.tsx
...
function ActivityLogTable({ logs }) {
	...
	const getActionBadgeClass = (actionType) => {
		switch (actionType) {
			case "CREATE_GRADE": return ActivityLogTable_module_default.actionCreate;
			case "UPDATE_GRADE": return ActivityLogTable_module_default.actionUpdate;
			case "DELETE_GRADE": return ActivityLogTable_module_default.actionDelete;
			default: return "";
		}
	};
	const getUserName = (log) => {
		if (log.expand?.user_id?.name) return log.expand.user_id.name;
		return log.user_id || "Unknown";
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: ActivityLogTable_module_default.container,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Activity Log" }), logs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: ActivityLogTable_module_default.emptyState,
			children: "No activity logs found"
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
			className: ActivityLogTable_module_default.table,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Old Value" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "New Value" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Timestamp" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "IP Address" })
			] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: logs.map((log) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: getUserName(log) }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: `${ActivityLogTable_module_default.actionBadge} ${getActionBadgeClass(log.action_type)}`,
					children: log.action_type
				}) }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
					className: ActivityLogTable_module_default.value,
					children: parseValue(log.old_value)
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
					className: ActivityLogTable_module_default.value,
					children: parseValue(log.new_value)
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: new Date(log.timestamp).toLocaleString() }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
					className: ActivityLogTable_module_default.ipAddress,
...
//#endregion
//#region src/assets/pages/Dashboard.tsx
function Dashboard() {
	const [totalGrades, setTotalGrades] = (0, import_react.useState)(0);
	const [recentLogs, setRecentLogs] = (0, import_react.useState)([]);
	...
	(0, import_react.useEffect)(() => {
		const fetchData = async () => {
			...
			setError(null);
			try {
				setTotalGrades((await getAllGrades()).length);
				setRecentLogs((await getActivityLogs()).slice(0, 10));
			} catch (err) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: { padding: "20px" },
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Dashboard" }),
			...
			loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Loading dashboard..." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: {
					display: "grid",
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Recent Activity" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ActivityLogTable, { logs: recentLogs })]
			})] })
		]
	});
}
...
var GradeTable_module_default = {
	container: "_container_1flww_1",
	emptyState: "_emptyState_1flww_29",
	table: "_table_1flww_49",
	gradeValue: "_gradeValue_1flww_139",
	editBtn: "_editBtn_1flww_151"
};
var EditGradeModal_module_default = {
	modalOverlay: "_modalOverlay_1bfbj_1",
	fadeIn: "_fadeIn_1bfbj_1",
	modal: "_modal_1bfbj_1",
	slideUp: "_slideUp_1bfbj_1",
	formGroup: "_formGroup_1bfbj_105",
	error: "_error_1bfbj_177",
	buttonGroup: "_buttonGroup_1bfbj_199",
	cancelBtn: "_cancelBtn_1bfbj_213",
	submitBtn: "_submitBtn_1bfbj_215"
};
//#endregion
//#region src/assets/components/EditGradeModal.tsx
function EditGradeModal({ grade, onClose, onSave }) {
	const [gradeValue, setGradeValue] = (0, import_react.useState)(grade.grade_value);
	const [loading, setLoading] = (0, import_react.useState)(false);
	const [error, setError] = (0, import_react.useState)(null);
	const getStudentName = () => {
		if (grade.expand?.student_id?.student_name) return grade.expand.student_id.student_name;
	...
	const handleSubmit = async (e) => {
		...
		setError(null);
		try {
			onSave(await updateGrade(grade.id, gradeValue, "teacher_1"));
		} catch (err) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: EditGradeModal_module_default.modalOverlay,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: EditGradeModal_module_default.modal,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "Edit Grade" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				onSubmit: handleSubmit,
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: EditGradeModal_module_default.formGroup,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Student: ", getStudentName()] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: EditGradeModal_module_default.formGroup,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Course: ", grade.expand?.student_id?.course || "-"] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: EditGradeModal_module_default.formGroup,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Section: ", grade.expand?.student_id?.section || "-"] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: EditGradeModal_module_default.formGroup,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: ["Subject: ", grade.subject] })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: EditGradeModal_module_default.formGroup,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { children: "Grade Value" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "number",
							min: "0",
							max: "100",
							value: gradeValue,
					...
					error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: EditGradeModal_module_default.error,
						children: error
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: EditGradeModal_module_default.buttonGroup,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: EditGradeModal_module_default.cancelBtn,
							onClick: onClose,
							disabled: loading,
							children: "Cancel"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "submit",
							className: EditGradeModal_module_default.submitBtn,
							disabled: loading,
...
//#endregion
//#region src/assets/components/GradeTable.tsx
function GradeTable({ grades, onGradeUpdated, onRefresh }) {
	const [selectedGrade, setSelectedGrade] = (0, import_react.useState)(null);
	...
	(0, import_react.useEffect)(() => {
		...
		const fetchUserNames = async () => {
			...
			for (const userId of uniqueUserIds) if (!names[userId]) names[userId] = await getUserName(userId);
			setUserNames(names);
		};
		if (uniqueUserIds.size > 0) fetchUserNames();
	}, [grades]);
	...
	const getModifierName = (grade) => {
		if (grade.expand?.last_modified_by?.name) return grade.expand.last_modified_by.name;
		return userNames[grade.last_modified_by] || grade.last_modified_by || "Unknown";
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: GradeTable_module_default.container,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "Student Grades" }), grades.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: GradeTable_module_default.emptyState,
			children: "No grades found"
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
			className: GradeTable_module_default.table,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Student Name" }),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Last Modified By" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Last Updated" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "Action" })
			] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: grades.map((grade) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: getStudentName(grade) }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: grade.expand?.student_id?.course || "-" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: grade.expand?.student_id?.section || "-" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: grade.subject }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
					className: GradeTable_module_default.gradeValue,
					children: grade.grade_value
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: getModifierName(grade) }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: new Date(grade.updated).toLocaleDateString() }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: GradeTable_module_default.editBtn,
					onClick: () => handleEditClick(grade),
					children: "Edit"
				}) })
			] }, grade.id)) })]
		})]
	}), showModal && selectedGrade && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EditGradeModal, {
		grade: selectedGrade,
...
//#endregion
//#region src/assets/pages/Grades.tsx
function Grades() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: { padding: "20px" },
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Grades Management" }),
			error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: {
					color: "#dc2626",
					marginBottom: "20px",
			...
			loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Loading grades..." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GradeTable, {
				grades,
				onGradeUpdated: () => {},
...
//#endregion
//#region src/assets/pages/Logs.tsx
function Logs() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		style: { padding: "20px" },
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Activity Logs" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				style: {
					color: "#666",
					marginBottom: "20px"
				},
				children: "All changes to grades are tracked here. Monitor who made what changes and when."
			}),
			error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				style: {
					color: "#dc2626",
			...
			loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Loading activity logs..." }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ActivityLogTable, { logs })
		]
	});
}
//#endregion
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Academic Grading System" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "brand-subtitle",
							children: "Tabletop Disaster Simulation"
						})
					]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
					currentPage === "dashboard" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dashboard, {}),
					currentPage === "grades" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Grades, {}),
					currentPage === "logs" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logs, {})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
				className: "footer",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "© 2026 Notre Dame University - Academic Grading System" })
			})
		]
	});
}
