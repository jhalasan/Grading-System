...
function ActivityLogTable({ logs }) {
  ...
  const getUserName2 = (log2) => {
    var _a, _b;
    if ((_b = (_a = log2.expand) == null ? void 0 : _a.user_id) == null ? void 0 : _b.name) {
      return log2.expand.user_id.name;
    }
    return "(User Deleted)";
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.container, children: logs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$2.emptyState, children: "No activity logs found" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: styles$2.table, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: logs.map((log2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: `${styles$2.actionBadge} ${getActionBadgeClass(log2.action_type)}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `bi ${getActionIcon(log2.action_type)}`, style: { marginRight: "4px" } }),
        log2.action_type
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: styles$2.value, children: parseValue(log2.old_value) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: styles$2.value, children: parseValue(log2.new_value) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: new Date(log2.timestamp).toLocaleString() })
    ] }, log2.id)) })
  ] }) });
}
